(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_report_completed-report_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/completed-report.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/completed-report.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _dataen__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./dataen */ "./resources/js/views/pages/report/dataen.js");
...
/* harmony import */ var _pages_components_report_completed_table_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../pages/components/report-completed-table.vue */ "./resources/js/views/pages/components/report-completed-table.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    CompletedTablle: _pages_components_report_completed_table_vue__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  data: function data() {
    return {
      title: this.$t('message.comprehensive_report'),
      submitted: false,
      pending: false,
      // datepicker
      endDate_min: '',
      datePickerAr: _data__WEBPACK_IMPORTED_MODULE_7__.datePickerAr,
      datePickerEn: _dataen__WEBPACK_IMPORTED_MODULE_8__.datePickerEn,
      dateFormatOptions: {
        year: 'numeric',
        month: 'numeric',
        day: 'numeric'
      ...
      // comonent data
      select_all_options: false,
      options: [{
        text: this.$t('message.rentaldocument'),
        value: 'rent_payment'
      }, {
        text: this.$t('message.taxRentalDocument'),
        value: 'rent_payment_tax'
      }, {
        text: this.$t('message.ownerReceiptDocument'),
        value: 'landlord_voucher_receipt'
      }, {
        text: this.$t('message.moneyExchangeDocument'),
        value: 'landlord_voucher_payment'
      }],
      rentPayments: [],
      totalRentPayments: 0,
      taxRentPayments: [],
  ...
  computed: {
    ...
    unSelectAllOptions: function unSelectAllOptions() {
      return this.form.selectedOptions.length === this.options.length;
    }
  },
  validations: {
    form: {
  ...
  watch: {
    ...
    'form.selectedOptions': function formSelectedOptions() {
      if (this.form.selectedOptions.length === 0) {
        this.select_all_options = false;
      } else if (this.form.selectedOptions.length === this.options.length) {
        this.select_all_options = true;
      } else {
        this.select_all_options = false;
      }
    }
  ...
  methods: {
    selectAll: function selectAll(e) {
      var selected = [];
      var that = this;
      that.select_all_options = !that.select_all_options;
      ...
      that.form.selectedOptions = selected;
    },
    print: function print() {
      this.$router.push({
        ...
        params: {
          ...
          totalRentPayments: this.totalRentPayments,
          taxRentPayments: this.taxRentPayments,
          totalTaxRentPayments: this.totalTaxRentPayments,
          totalTaxValue: this.totalTaxValue,
          landlordVoucherReceipts: this.landlordVoucherReceipts,
          totalLandlordVoucherReceipts: this.totalLandlordVoucherReceipts,
          landlordVoucherPayments: this.landlordVoucherPayments,
          totalLandlordVoucherPayments: this.totalLandlordVoucherPayments
        }
      });
    },
    excel: function excel(type, fn, dl) {
      var elt = this.$refs.completed_table.$refs.table1;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                if (!(that.form.selectedOptions.length === 0)) {
                  _context2.next = 11;
                  break;
                }

                that.$iziToast.error({
                  message: 'يجب اختيار خيار واحد علي الاقل',
              ...
              case 11:
                ...
                _context2.next = 16;
                return that.axios.post('report/completed', formData).then(function (response) {
                  that.submitted = false; // console.log(response.data);

                  // console.log(response.data);
                  that.rentPayments = response.data.rentPayments;
                  that.totalRentPayments = response.data.totalRentPayments;
                  that.taxRentPayments = response.data.taxRentPayments;
                  that.totalTaxRentPayments = response.data.totalTaxRentPayments;
                  that.totalTaxValue = response.data.totalTaxValue;
                  that.landlordVoucherReceipts = response.data.landlordVoucherReceipts;
                  that.totalLandlordVoucherReceipts = response.data.totalLandlordVoucherReceipts;
                  that.landlordVoucherPayments = response.data.landlordVoucherPayments;
                  that.totalLandlordVoucherPayments = response.data.totalLandlordVoucherPayments;
  ...
  mounted: function mounted() {
    ...
    this.pending = true;
    this.axios.all([this.getAppSettings()])["finally"](function () {
...
/***/ "./resources/js/views/pages/report/completed-report.vue":
/*!**************************************************************!*\
  !*** ./resources/js/views/pages/report/completed-report.vue ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _completed_report_vue_vue_type_template_id_b4139c92___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./completed-report.vue?vue&type=template&id=b4139c92& */ "./resources/js/views/pages/report/completed-report.vue?vue&type=template&id=b4139c92&");
/* harmony import */ var _completed_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./completed-report.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/report/completed-report.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _completed_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _completed_report_vue_vue_type_template_id_b4139c92___WEBPACK_IMPORTED_MODULE_0__.render,
  _completed_report_vue_vue_type_template_id_b4139c92___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/report/completed-report.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./resources/js/views/pages/report/completed-report.vue?vue&type=script&lang=js&":
/*!***************************************************************************************!*\
  !*** ./resources/js/views/pages/report/completed-report.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_completed_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./completed-report.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/completed-report.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_completed_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/report/completed-report.vue?vue&type=template&id=b4139c92&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/views/pages/report/completed-report.vue?vue&type=template&id=b4139c92& ***!
  \*********************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_completed_report_vue_vue_type_template_id_b4139c92___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   "staticRenderFns": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_completed_report_vue_vue_type_template_id_b4139c92___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_completed_report_vue_vue_type_template_id_b4139c92___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./completed-report.vue?vue&type=template&id=b4139c92& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/completed-report.vue?vue&type=template&id=b4139c92&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/completed-report.vue?vue&type=template&id=b4139c92&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/completed-report.vue?vue&type=template&id=b4139c92& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                            ...
                            _c(
                              ...
                              [
                                _c("input", {
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.select_all_options,
                                      expression: "select_all_options"
                                    }
                                  ],
                                  ...
                                  domProps: {
                                    checked: Array.isArray(
                                      _vm.select_all_options
                                    )
                                      ? _vm._i(_vm.select_all_options, null) >
                                        -1
                                      : _vm.select_all_options
                                  },
                                  on: {
                                    change: [
                                      function($event) {
                                        ...
                                        if (Array.isArray($$a)) {
                                          ...
                                          if ($$el.checked) {
                                            $$i < 0 &&
                                              (_vm.select_all_options = $$a.concat(
                                                [$$v]
                                              ))
                                          } else {
                                            $$i > -1 &&
                                              (_vm.select_all_options = $$a
                                                .slice(0, $$i)
                                                .concat($$a.slice($$i + 1)))
                                          }
                                        } else {
                                          _vm.select_all_options = $$c
                                        }
                                      },
                                      _vm.selectAll
                                    ]
                                ...
                                _c(
                                  ...
                                  [_vm._v(_vm._s(_vm.$t("message.all")))]
                                )
                              ]
                            )
                          ]),
                                  ...
                                  _c("input", {
                                    ...
                                    on: {
                                      change: function($event) {
                                        var $$a = _vm.form.selectedOptions,
                                          $$el = $event.target,
                                          $$c = $$el.checked ? true : false
                                        if (Array.isArray($$a)) {
                                          var $$v = option.value,
