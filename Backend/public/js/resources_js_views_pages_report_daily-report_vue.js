(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_report_daily-report_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/daily-report.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/daily-report.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data */ "./resources/js/views/pages/report/data.js");
...
/* harmony import */ var _pages_components_daily_report_table_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../pages/components/daily-report-table.vue */ "./resources/js/views/pages/components/daily-report-table.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    DailyReportTable: _pages_components_daily_report_table_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  data: function data() {
    return {
      title: this.$t('message.daily_report'),
      submitted: false,
      pending: false,
      hasResult: false,
      // datepicker
      datePickerAr: _data__WEBPACK_IMPORTED_MODULE_6__.datePickerAr,
      dateFormatOptions: {
        year: 'numeric',
        month: 'numeric',
        day: 'numeric'
  ...
  watch: {
    'form.date_gregory': function formDate_gregory() {
      this.form.date_hijri = this.moment(this.form.date_gregory, 'YYYY-MM-DD').locale('en').format('iYYYY-iM-iD');
    }
  },
  methods: {
    addToday: function addToday() {
      this.form.date_gregory = this.moment().locale('en').format('YYYY-MM-DD');
    },
    addDay: function addDay() {
      var momentObj = this.moment(this.form.date_gregory, 'YYYY-MM-DD').locale('en');
      this.form.date_gregory = momentObj.add(1, 'days').format('YYYY-MM-DD');
    },
    removeDay: function removeDay() {
      var momentObj = this.moment(this.form.date_gregory, 'YYYY-MM-DD').locale('en');
      this.form.date_gregory = momentObj.subtract(1, 'days').format('YYYY-MM-DD');
    },
    ...
    print: function print() {
      this.$router.push({
        ...
        params: {
          ...
          total_rent_payment: this.total_rent_payment,
          total_voucher_payment: this.total_voucher_payment,
          total_balance: this.total_balance
        }
      });
    },
    excel: function excel(type, fn, dl) {
      var elt = this.$refs.daily_report_table.$refs.table1;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                _context2.next = 12;
                return that.axios.post('report/daily', formData).then(function (response) {
                  that.submitted = false;
                  that.hasResult = true; // console.log(response.data);

                  // console.log(response.data);
                  that.landlords = response.data.landlords;
                  that.total_rent_payment = 0;
                  that.total_voucher_payment = 0;
                  that.total_balance = 0;
                  that.total_rent_payment = response.data.total_rent_payment;
                  that.total_voucher_payment = response.data.total_voucher_payment;
  ...
  mounted: function mounted() {
    ...
    this.pending = true;
    this.axios.all([this.getAppSettings(), this.initValue()])["finally"](function () {
...
/***/ "./resources/js/views/pages/report/daily-report.vue":
/*!**********************************************************!*\
  !*** ./resources/js/views/pages/report/daily-report.vue ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _daily_report_vue_vue_type_template_id_3e9af9a9___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./daily-report.vue?vue&type=template&id=3e9af9a9& */ "./resources/js/views/pages/report/daily-report.vue?vue&type=template&id=3e9af9a9&");
/* harmony import */ var _daily_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./daily-report.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/report/daily-report.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _daily_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _daily_report_vue_vue_type_template_id_3e9af9a9___WEBPACK_IMPORTED_MODULE_0__.render,
  _daily_report_vue_vue_type_template_id_3e9af9a9___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/report/daily-report.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./resources/js/views/pages/report/daily-report.vue?vue&type=script&lang=js&":
/*!***********************************************************************************!*\
  !*** ./resources/js/views/pages/report/daily-report.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_daily_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./daily-report.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/daily-report.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_daily_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/report/daily-report.vue?vue&type=template&id=3e9af9a9&":
/*!*****************************************************************************************!*\
  !*** ./resources/js/views/pages/report/daily-report.vue?vue&type=template&id=3e9af9a9& ***!
  \*****************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_daily_report_vue_vue_type_template_id_3e9af9a9___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   "staticRenderFns": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_daily_report_vue_vue_type_template_id_3e9af9a9___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_daily_report_vue_vue_type_template_id_3e9af9a9___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./daily-report.vue?vue&type=template&id=3e9af9a9& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/daily-report.vue?vue&type=template&id=3e9af9a9&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/daily-report.vue?vue&type=template&id=3e9af9a9&":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/daily-report.vue?vue&type=template&id=3e9af9a9& ***!
  \********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                                    ...
                                    [
                                      ...
                                      _vm.$v.form.date_gregory.$error
                                        ? _c(
                                            ...
                                            [
                                              !_vm.$v.form.date_gregory.required
                                                ? _c("span", [
                                                    _vm._v(
                                                      _vm._s(
                                                        _vm.$t(
