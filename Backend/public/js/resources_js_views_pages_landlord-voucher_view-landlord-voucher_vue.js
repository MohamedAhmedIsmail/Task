(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_landlord-voucher_view-landlord-voucher_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _layout_mainLayout__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../layout/mainLayout */ "./resources/js/views/layout/mainLayout.vue");
/* harmony import */ var _components_page_header__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/components/page-header */ "./resources/js/components/page-header.vue");
...
var lessThanCredit = function lessThanCredit(value, vm) {
  return vm.voucher_type == 'payment' ? Number(value) <= vm.landlordCredit : true;
};
/*
 * view Landlord Voucher
 */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Layout: _layout_mainLayout__WEBPACK_IMPORTED_MODULE_10__["default"],
    PageHeader: _components_page_header__WEBPACK_IMPORTED_MODULE_11__["default"],
    vSelect: (vue_select__WEBPACK_IMPORTED_MODULE_12___default())
  },
  data: function data() {
    return {
      name: 'View Landlord Voucher',
      title: this.$t('message.showAngelBonds'),
      items: [{
        text: this.$t('message.angelBonds'),
        href: "/landlord-vouchers"
      }],
      form: {
        landlord_id: "",
        voucher_type: "",
        voucher_date_gregory: "",
        voucher_date_hijri: "",
        amount: "",
        payment_type: "",
  ...
  validations: {
    form: {
      ...
      amount_note_statment: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.required,
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_14__.maxLength)(250)
      }
    }
  },
  computed: {
    totalRentPayment: function totalRentPayment() {
      if (this.selectedLandlord != '') {
        return this.selectedLandlord.rent_payment.reduce(function (s, f) {
    ...
    paymentVouchers: function paymentVouchers() {
      return this.selectedLandlord != '' ? this._.filter(this.selectedLandlord.vouchers, function (item) {
        return item.voucher_type == "payment";
      }) : [];
    },
    receiptVouchers: function receiptVouchers() {
      return this.selectedLandlord != '' ? this._.filter(this.selectedLandlord.vouchers, function (item) {
        return item.voucher_type == "receipt";
      }) : [];
    },
    totalPaymentVouchers: function totalPaymentVouchers() {
      if (this.selectedLandlord != '') {
        return this.paymentVouchers.reduce(function (s, f) {
    ...
    totalReceiptVouchers: function totalReceiptVouchers() {
      if (this.selectedLandlord != '') {
        return this.receiptVouchers.reduce(function (s, f) {
          return s + Number(f.amount);
        }, 0);
      }
    ...
    filtered: function filtered() {
      ...
      return this.landlords.filter(function (landlord) {
        return landlord.landlord_name ? landlord.landlord_name.toLowerCase().includes(that.search.toLowerCase()) : '';
      });
    },
  ...
  methods: {
    ...
    isNumber: function isNumber(e) {
      ...
      if (/^[0-9]\d*$|^$/.test(_char)) return true; // Match with regex 
    ...
    changedValue: function changedValue(value) {
      ...
      if (this.selectedLandlord != '') {
        this.form.landlordCredit = this.totalRentPayment + this.totalReceiptVouchers - this.totalPaymentVouchers;
      }
    },
    ...
    getLandlordVoucher: function getLandlordVoucher() {
      var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                that = _this2;
                _context2.next = 3;
                return that.axios.get('landlord-voucher/edit/' + _this2.$route.params.id).then(function (response) {
                  that.form = response.data;
                  that.selectedLandlord = that.form.landlord;
                  that.form.landlordCredit = that.totalRentPayment + that.totalReceiptVouchers - that.totalPaymentVouchers;
                  that.dateStatment = that.moment(that.form.voucher_date_gregory, 'YYYY/MM/DD').locale('ar').format('iYYYY/iM/iD هـ الموافق YYYY/M/D م');
                });
    ...
    getLandlordList: function getLandlordList() {
      var _this3 = this;
  ...
  mounted: function mounted() {
    ...
    this.pending = true;
    this.axios.all([this.getLandlordList(), this.getLandlordVoucher(), this.getAppSettings()])["finally"](function () {
...
/***/ "./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue":
/*!*****************************************************************************!*\
  !*** ./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue ***!
  \*****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_landlord_voucher_vue_vue_type_template_id_6a4a2745___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view-landlord-voucher.vue?vue&type=template&id=6a4a2745& */ "./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=template&id=6a4a2745&");
/* harmony import */ var _view_landlord_voucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view-landlord-voucher.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _view_landlord_voucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _view_landlord_voucher_vue_vue_type_template_id_6a4a2745___WEBPACK_IMPORTED_MODULE_0__.render,
  _view_landlord_voucher_vue_vue_type_template_id_6a4a2745___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_view_landlord_voucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./view-landlord-voucher.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_view_landlord_voucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=template&id=6a4a2745&":
/*!************************************************************************************************************!*\
  !*** ./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=template&id=6a4a2745& ***!
  \************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_view_landlord_voucher_vue_vue_type_template_id_6a4a2745___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   "staticRenderFns": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_view_landlord_voucher_vue_vue_type_template_id_6a4a2745___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_view_landlord_voucher_vue_vue_type_template_id_6a4a2745___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./view-landlord-voucher.vue?vue&type=template&id=6a4a2745& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=template&id=6a4a2745&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=template&id=6a4a2745&":
/*!***************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/landlord-voucher/view-landlord-voucher.vue?vue&type=template&id=6a4a2745& ***!
  \***************************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12" }, [
          _c(
            "div",
            {
              staticClass: "card landlord_v",
              class: {
                payment_shadow: _vm.form.voucher_type == "payment",
                receipt_shadow: _vm.form.voucher_type == "receipt"
              }
            },
            [
              _c(
                      ...
                      _c("fieldset", { attrs: { disabled: "true" } }, [
                        _c("div", { staticClass: "row" }, [
                            ...
                            _c("div", { staticClass: "form-group mb-3" }, [
                              ...
                              _c(
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.form.voucher_type,
                                      expression: "form.voucher_type"
                                    }
                                  ],
                                  staticClass: "custom-select form-control",
                                  class: {
                                    "is-invalid":
                                      _vm.$v.form.voucher_type.$error
                                  },
                                  on: {
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      _vm._v(
                                        _vm._s(_vm.$t("message.chooseTypeBond"))
                                      )
                                    ]
                                  ),
                                  _vm._v(" "),
                              ...
                              _vm.$v.form.voucher_type.$error
                                ? _c(
                                    ...
                                    [
                                      !_vm.$v.form.voucher_type.required
                                        ? _c("span", [
                                            _vm._v(
                                              _vm._s(
                              ...
                              ? _c(
                                  ...
                                  [
                                    _c(
                                      "label",
                                      {
                                        staticClass: "text_animate",
                                        class: {
                                          red_text:
                                            _vm.form.voucher_type == "payment",
                                          green_text:
                                            _vm.form.voucher_type == "receipt"
                                        },
                                        attrs: { for: "name" }
                                      },
                                      [
                                    ...
                                    _vm._v(" "),
                                    !_vm.$v.form.landlord_id.required
                                      ? _c(
                                          "div",
                                          { staticClass: "invalid-feedback" },
                                          [
                            ...
                            _vm.selectedLandlord != ""
                              ? _c("div", { staticClass: "form-group mb-3" }, [
                                  ...
                                  _c("input", {
                                    ...
                                    class: {
                                      "is-invalid": _vm.$v.form.amount.$error
                                    },
                                    ...
                                    ? _c(
                                        ...
                                        [
                                          !_vm.$v.form.amount.required
                                            ...
                                            : _vm._e(),
                                          _vm._v(" "),
                                          !_vm.$v.form.amount.lessThanCredit
                                            ? _c("span", [
                                                _vm._v(
                                                  _vm._s(
                                                    _vm.$t(
                                                      "message.amountBalance"
                                                    )
                                                  )
                                                )
                                              ])
                              ...
                              ? _c("div", { staticClass: "form-group mb-3" }, [
                                  ...
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c(
                                        "option",
                                        { attrs: { value: "transfer" } },
                                        [
                                          _vm._v(
                                            _vm._s(_vm.$t("message.transfer"))
                                          )
                                        ]
                                      )
                                    ]
                          ...
                          _c("div", { staticClass: "col-sm-6" }, [
                            ...
                            _c("div", { staticClass: "form-group mb-3" }, [
                              _c("label", { attrs: { for: "name" } }, [
                                _vm._v(_vm._s(_vm.$t("message.ownerBalance")))
                              ]),
                              _vm._v(" "),
                              _c("h5", { staticClass: "mt-1" }, [
                                _vm._v(
                            ...
                            _vm.selectedLandlord != ""
                              ? _c(
                                  ...
                                  [
                                    _c("label", { attrs: { for: "name" } }, [
                                      _vm._v(
                                        _vm._s(_vm.$t("message.recipient")) +
                                          ":"
                                      )
                                    ]),
                                    _vm._v(" "),
                                    _c("h5", { staticClass: "mt-1" }, [
                                      _vm._v(
                                        _vm._s(
                                          _vm.selectedLandlord != ""
                                            ? _vm.selectedLandlord.agent_name
                                            : ""
                                        ) + "  "
                                      )
                                    ])
