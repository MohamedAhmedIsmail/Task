(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_report_incoming-bonds_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/incoming-bonds.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/incoming-bonds.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _pages_components_incoming_bonds_table_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../pages/components/incoming-bonds-table.vue */ "./resources/js/views/pages/components/incoming-bonds-table.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    AccStatementTablle: _pages_components_incoming_bonds_table_vue__WEBPACK_IMPORTED_MODULE_12__["default"]
  },
  data: function data() {
    return {
      title: this.$t('message.incoming_bond_report'),
      submitted: false,
      pending: false,
      endDate_min: '',
  ...
  computed: {
    landlordName: function landlordName() {
      return this.selectedLandlord != '' ? this.selectedLandlord.landlord_name : '';
    },
    propertyName: function propertyName() {
      return this.selectedProperty != '' ? this.selectedProperty.property_name : '';
    },
    filteredLandlord: function filteredLandlord() {
      var that = this;
      return this.landlords.filter(function (landlord) {
        return landlord.landlord_name ? landlord.landlord_name.toLowerCase().includes(that.search_landlord.toLowerCase()) : '';
      });
    },
    filteredProperty: function filteredProperty() {
      var that = this;
      return this.properties.filter(function (property) {
        return property.property_name ? property.property_name.toLowerCase().includes(that.search_property.toLowerCase()) : '';
      });
    },
    paginatedOptionsLandlord: function paginatedOptionsLandlord() {
      return this.filteredLandlord.slice(this.offset_landlord, this.limit + this.offset_landlord);
    },
    paginatedOptionsProperty: function paginatedOptionsProperty() {
      return this.filteredProperty.slice(this.offset_property, this.limit + this.offset_property);
    },
    hasNextPageLandlord: function hasNextPageLandlord() {
      var nextOffset = this.offset_landlord + this.limit;
      return Boolean(this.filteredLandlord.slice(nextOffset, this.limit + nextOffset).length);
    },
    hasNextPageProperty: function hasNextPageProperty() {
      var nextOffset = this.offset_property + this.limit;
      return Boolean(this.filteredProperty.slice(nextOffset, this.limit + nextOffset).length);
    },
    hasPrevPageLandlord: function hasPrevPageLandlord() {
      var prevOffset = this.offset_landlord - this.limit;
      return Boolean(this.filteredLandlord.slice(prevOffset, this.limit + prevOffset).length);
    },
    hasPrevPageProperty: function hasPrevPageProperty() {
      var prevOffset = this.offset_property - this.limit;
      return Boolean(this.filteredProperty.slice(prevOffset, this.limit + prevOffset).length);
    }
  },
  validations: {
    form: {
  ...
  watch: {
    'form.landlord_id': function formLandlord_id() {
      if (this.form.landlord_id != this.selectedLandlord.id) {
        this.selectedLandlord = '';
      }
    },
    'form.property_id': function formProperty_id() {
      if (this.form.property_id != this.selectedProperty.id) {
  ...
  methods: {
    ...
    excel: function excel(type, fn, dl) {
      var elt = this.$refs.incoming_bonds_table.$refs.table1;
    ...
    changedValueLandlord: function changedValueLandlord(value) {
      // console.log(value);
      this.selectedLandlord = value;
      this.form.landlordName = this.landlordName;
      this.form.property_id = '';
      this.form.propertyName = '';
    },
    changedValueProperty: function changedValueProperty(value) {
      // console.log(value);
      this.selectedProperty = value;
      this.form.propertyName = this.propertyName;
      this.form.landlord_id = '';
      this.form.landlordName = '';
    },
    onSearchLandlord: function onSearchLandlord(query) {
      this.search_landlord = query;
      this.offset_landlord = 0;
    },
    onSearchProperty: function onSearchProperty(query) {
      this.search_property = query;
      this.offset_property = 0;
    },
    getLandlordsList: function getLandlordsList() {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                that = _this;
                _context.next = 3;
                return that.axios.get("landlords/all").then(function (response) {
                  that.landlords = response.data; // console.log(that.landlords);
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                that = _this2;
                _context2.next = 3;
                return that.axios.get("properties/all").then(function (response) {
                  that.properties = response.data; // console.log(that.landlords);
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                if (!((that.form.landlord_id == '' || that.form.landlord_id == null) && (that.form.property_id == '' || that.form.property_id == null))) {
                  _context4.next = 11;
                  break;
                }

                that.$iziToast.error({
                  message: 'يجب اختيار مالك او عقار',
              ...
              case 11:
                ...
                _context4.next = 16;
                return that.axios.post('report/incoming-bonds', formData).then(function (response) {
                  that.submitted = false;
                  that.hasResult = true; // console.log(response.data);

                  // console.log(response.data);
                  that.rentPayments = response.data.rentPayments;
                  that.total_balance = 0;
                  that.total_balance = response.data.total_balance;
  ...
  mounted: function mounted() {
    ...
    this.pending = true;
    this.axios.all([this.getLandlordsList(), this.getPropertiesList(), this.getAppSettings()])["finally"](function () {
...
/***/ "./resources/js/views/pages/report/incoming-bonds.vue":
/*!************************************************************!*\
  !*** ./resources/js/views/pages/report/incoming-bonds.vue ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _incoming_bonds_vue_vue_type_template_id_fa51c5ac___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./incoming-bonds.vue?vue&type=template&id=fa51c5ac& */ "./resources/js/views/pages/report/incoming-bonds.vue?vue&type=template&id=fa51c5ac&");
/* harmony import */ var _incoming_bonds_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./incoming-bonds.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/report/incoming-bonds.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _incoming_bonds_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _incoming_bonds_vue_vue_type_template_id_fa51c5ac___WEBPACK_IMPORTED_MODULE_0__.render,
  _incoming_bonds_vue_vue_type_template_id_fa51c5ac___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/report/incoming-bonds.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
...
/***/ "./resources/js/views/pages/report/incoming-bonds.vue?vue&type=script&lang=js&":
/*!*************************************************************************************!*\
  !*** ./resources/js/views/pages/report/incoming-bonds.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_incoming_bonds_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./incoming-bonds.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/incoming-bonds.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_incoming_bonds_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/report/incoming-bonds.vue?vue&type=template&id=fa51c5ac&":
/*!*******************************************************************************************!*\
  !*** ./resources/js/views/pages/report/incoming-bonds.vue?vue&type=template&id=fa51c5ac& ***!
  \*******************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_incoming_bonds_vue_vue_type_template_id_fa51c5ac___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   "staticRenderFns": function() { return /* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_incoming_bonds_vue_vue_type_template_id_fa51c5ac___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_incoming_bonds_vue_vue_type_template_id_fa51c5ac___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./incoming-bonds.vue?vue&type=template&id=fa51c5ac& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/incoming-bonds.vue?vue&type=template&id=fa51c5ac&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/incoming-bonds.vue?vue&type=template&id=fa51c5ac&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/report/incoming-bonds.vue?vue&type=template&id=fa51c5ac& ***!
  \**********************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                              ...
                              [
                                ...
                                _c(
                                  "v-select",
                                  {
                                    attrs: {
                                      filterable: false,
                                      options: _vm.paginatedOptionsLandlord,
                                      reduce: function(landlord) {
                                        return landlord.id
                                      },
                                      label: "landlord_name"
                                    },
                                    on: {
                                      search: _vm.onSearchLandlord,
                                      "option:selected":
                                        _vm.changedValueLandlord
                                    },
                                    model: {
                                      value: _vm.form.landlord_id,
                                      callback: function($$v) {
                                        _vm.$set(_vm.form, "landlord_id", $$v)
                                      },
                                      expression: "form.landlord_id"
                                    }
                                  },
                                  [
                                    _c(
                                      ...
                                      [
                                        _c(
                                          ...
                                          {
                                            attrs: {
                                              disabled: !_vm.hasPrevPageLandlord
                                            },
                                            on: {
                                              click: function($event) {
                                                _vm.offset_landlord -= _vm.limit
                                              }
                                            }
                                          },
                                          [
                                        ...
                                        _c(
                                          ...
                                          {
                                            attrs: {
                                              disabled: !_vm.hasNextPageLandlord
                                            },
                                            on: {
                                              click: function($event) {
                                                _vm.offset_landlord += _vm.limit
                              ...
                              [
                                ...
                                _c(
                                  "v-select",
                                  {
                                    attrs: {
                                      filterable: false,
                                      options: _vm.paginatedOptionsProperty,
                                    ...
                                    on: {
                                      search: _vm.onSearchProperty,
                                      "option:selected":
                                        _vm.changedValueProperty
                                    },
                                    model: {
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c(
                                          ...
                                          {
                                            attrs: {
                                              disabled: !_vm.hasPrevPageProperty
                                            },
                                            on: {
                                              click: function($event) {
                                                _vm.offset_property -= _vm.limit
                                              }
                                            }
                                          },
                                          [
                                        ...
                                        _c(
                                          ...
                                          {
                                            attrs: {
                                              disabled: !_vm.hasNextPageProperty
                                            },
                                            on: {
                                              click: function($event) {
                                                _vm.offset_property += _vm.limit
