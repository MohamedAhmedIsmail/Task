...
{{--            <img src="{{ url('assets/images/faces/face8.jpg') }}" alt="profile image">--}}
          ...
          <div class="text-wrapper">
            <p class="profile-name">{{Session::get('email')}}</p>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="basic-ui">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/allAdmins') }}">All Admins</a>
          </li>
        </ul>
      </div>
    </li>
      <li class="nav-item">
          <a class="nav-link" data-toggle="collapse" href="#users" aria-expanded="" aria-controls="users">
              <i class="menu-icon mdi mdi-worker"></i>
              <span class="menu-title">User Staff</span>
              <i class="menu-arrow"></i>
          </a>
          <div class="collapse" id="users">
              <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item ">
                      <a class="nav-link" href="{{ url('/createUser') }}">Create User</a>
                  </li>
      ...
      <li class="nav-item">
          <a class="nav-link" data-toggle="collapse" href="#suppliers" aria-expanded="" aria-controls="suppliers">
      ...
      <li class="nav-item">
          <a class="nav-link" data-toggle="collapse" href="#bargains" aria-expanded="" aria-controls="bargains">
              <i class="menu-icon mdi mdi-lock-outline"></i>
              <span class="menu-title">Movies</span>
              <i class="menu-arrow"></i>
          </a>
          <div class="collapse" id="bargains">
              <ul class="nav flex-column sub-menu">
                  <li class="nav-item ">
                      <a class="nav-link" href="{{ url('/movies') }}">All Movies</a>
                  </li>
                  <li class="nav-item ">
                      <a class="nav-link" href="{{ url('/movies/create') }}">Create Movie</a>
                  </li>
